...
<article class="news" class:disabled>
  <img src={news.thumbnails.mobile} alt="">

  <div class="body">
    {#if expanded}
      <button class="goback" onclick={() => {goto('/news')}} transition:fade={{duration: 200}}>
...
<style lang="scss">
  ...
  article:not(.expanded) h2 a::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
